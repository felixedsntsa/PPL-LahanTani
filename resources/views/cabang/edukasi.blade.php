...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 px-4 py-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col h-full">
                <!-- YouTube Thumbnail -->
                ...
                <div class="p-6 flex flex-col flex-grow">
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="text-gray-600 mb-4 line-clamp-3 text-justify">{{ $item->penjelasan }}</p>
                    </div>
